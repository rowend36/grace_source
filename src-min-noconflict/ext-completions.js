...
(function(){
    ...
    this.filterCompletions = function(items, needle) {
        ...
        loop: for (var i = 0, item; item = items[i]; i++) {
            ...
            item.exactMatch = penalty ? 0 : (caption.length==needle.length)?2:1;
...
define("ace/ext/completions",["require","exports","module","ace/config","ace/lib/lang","ace/autocomplete/util","ace/snippets","ace/autocomplete/text_completer","ace/autocomplete","ace/editor"], function(require, exports, module) {
"use strict";    
var config = require("../config");
var lang = require("../lib/lang"); 
var util = require("../autocomplete/util");
...
Autocomplete.tabCommand = {
    ...
    exec: function(editor, e) {
        ...
        if (editor.getSelection().isEmpty() && prefix && !hasCompleter) {
            var completer = Autocomplete.for(editor);
...
config.defineOptions(Editor.prototype, "editor", {
    ...
    enableIntelligentAutocompletion: {
        ...
        value: true
                ...
                (function() {
                    window.require(["ace/ext/completions"], function(m) {
