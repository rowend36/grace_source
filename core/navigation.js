_Define(function(global) {
    ...
    var InvisibleTextArea = function(el) {
        ...
        receiver.setAttribute("name", global.Utils.genID("qt"));
        el.appendChild(receiver);
        return receiver;
    };
    global.InvisibleTextArea = InvisibleTextArea;
});
_Define(function(global) {
    var FocusManager = global.FocusManager;
    var InvisibleTextArea = global.InvisibleTextArea;
        ...
        attach: function(el, keyHandler) {
            ...
            event.addCommandKeyListener(el, function(e, hash, key) {
                ...
                keyHandler.$onKey({
                    event: e,
                    value: keyString,
                    repeating: KeyListener.repeating
                });
            ...
            if (!keyHandler.$onKey) {
                keyHandler.$onKey = defaultKeyHandler.bind(keyHandler);
            }
...
_Define(function(global) {
    ...
    var nav = {
        ...
        pop: Utils.noop,
        attach: Imports.define(["./libs/js/tabbable.js", './tools/enhanced_navigation.js'], null, Utils
            .noop),
        detach: Utils.noop
    };
