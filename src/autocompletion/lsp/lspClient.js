_Define(function(global) {
    ...
    */
    function LspClient(transport, options) {
        this.aceCommands = createCommands(options, "lspClient", "lsp");
        ...
        this.errorCount = 0;
        this.restart(this.options.serverOptions);
    }
    ...
    LspClient.prototype = {
        ...
        restart: function(serverOpts) {
            this.options.serverOptions = serverOpts;
            for (var i in this.docs) {
                this.invalidateDoc(this.docs[i]);
            }
            this.send("restart", [serverOpts]);
        },
    ...
    Utils.inherits(LspClient,BaseServer);
