...
Except autocompletion.tags.tagFilePattern, all the options can be specified in a simple format of true|false followed by an optional list of modes to treat as exceptions. Example "true,javascript,css" means enable except in javascript and css modes',
    ...
    var tagFilePattern = global.FileUtils.globToRegex(appConfig.tagFilePattern);
    ...
    */
    ...
    Tags.prototype = {
        ...
        loadTags: function(filename, res /*Doc or string*/ , noOverwrite /*false*/ , mode) {
            ...
            if (!mode) {
                if (extname(filename) == "gtag") {
                    ...
                    return Imports.define([{
                        script: "./autocompletion/tags/ctags.js",
                        returns: 'Ctags'
                    }])(function(Ctags) {
                        Ctags.findAll(res, filename, false, Utils.noop);
                    });
                }
        ...
        getCompletions: function(editor, session, pos, prefix, callback) {
            ...
            var allowTags;
            try {
                allowTags = doc && doc.flags && doc.flags.allowTagsFrom && global.FileUtils
                    .globToRegex(
    ...
    global.ServerUtils.createCommands(Tags.prototype, "tagsClient",
        TAGS);
    ...
    global.ConfigEvents.on("autocompletion.tags", function(e) {
        enabledCache = {};
        tagFilePattern = global.FileUtils.globToRegex(appConfig.tagFilePattern);
