_Define(function(global) {
            ...
            this.server.request(
                ...
                function(error, data) {
                    ...
                    if (data.file) {
                        ...
                        ts.ui.showError(editor, "Could not find a definition.");
                }
            );
        },
            ...
            this.request(
                ...
                function(error, data) {
                    ...
                    if (!error && data.changes) {
                        ...
                        if (isAsync) {
                            return BaseServer.prototype.requestRename.call(
                                ts,
                                editor,
                                cb,
                                data.changes
    ...
    function getFile(ts, name, cb) {
        ...
        else if (ts.options.readFile) ts.options.readFile(name, cb);//no filtering
        else cb(null);
    }
