_Define(function(global) {
  ...
  var loadFiles = global.ServerHost.loadAutocompleteFiles;
  ...
  global.tsCompletionProvider = {
    init: Imports.define(["./autocompletion/typescript/tsClient.js"], null, function(editor, cb) {
      ...
      var reuse = editor.tsClient || initOptions.server || (initOptions.shared !== false && this.instance);
      if (reuse) {
        ...
        var instance = new global.TsServer(new Transport(function(path) {
          global.tsCompletionProvider.options.readFile(path, function(e, res) {
            if (!e && res) {
