    ...
    var SearchTab = function(el) {
        ...
        var openModal = function() {
            ...
            if (!modalEl) {
                ...
                self.previewBrowser = new ProjectView(modalEl.find(".fileview"), project.rootDir,
                    project
                    .fileServer);
            ...
            modalEl.modal("open");
            var dotstar = global.allConfigs.files.dotStar;
            if (dotstar) {
        ...
        var find = function() {
            ...
            try {
                ...
                showSearchStarted();
                return showSearching(" ", "<span class='error-text'>" + e.message + "</span>");
            }
        ...
        find = global.Imports.define([
                "./ui/overlayMode.js",
                "./ui/rangeRenderer.js",
                "./libs/js/brace-expansion.js", //core
                "./search/searchList.js", //dynamic
                "./search/searchResults.js", //dynamic
                "./search/searchReplace.js"
            ], //dynamic
            function() {
                SearchResults = global.SearchResults;
                SearchReplace = global.SearchReplace;
                SearchList = global.SearchList;
                searchResults = new SearchResults(el.children("#searchResults"), useRecycler);
