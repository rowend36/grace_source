define(function(require,exports,module) {
    ...
    require("./libs/brace-expansion");
    var braceExpand = window.braceExpand;
    var regEscape = require("grace/core/utils").Utils.regEscape;
    var appConfig = require("grace/core/config").Config.registerAll({}, 'files');
    ...
    */
    ...
    FileUtils.copyFile = function(path, newpath, server, newserver, cb) {
    ...
    FileUtils.moveFile = function(path, newpath, server, newserver, cb) {
        newserver = newserver || server;
    ...
    FileUtils.copyFolder = function(path, newpath, server, newServer, cb, onConflict, onEach) {
        FileUtils.moveFolder(path, newpath, server, newServer, cb, onConflict, onEach, true);
    };
    FileUtils.moveFolder = function(path, newpath, server, newServer, cb, onConflict, onEach, isCopy) {
        newServer = newServer || server;
