define(function(require,exports,module) {
    ...
    var Mods = require("grace/ext/character_bar/mods").Mods;
    ...
    var savedClip = require("grace/core/config").Config.getObj("clipboard", []);
    if (savedClip.length) {
    ...
    if (!Env.setClipboard) {
        ...
        var setClipExec = function(text, callback) {
            ...
            var result = document.execCommand("copy") ?
                undefined : require("grace/core/config").createError({
                    code: "EUNKNOWN",
    ...
    Editors.addCommands([{
        ...
        exec: function() {
            require(["grace/ui/itemlist"], function(mod) {
                clipboardList = new mod.BottomList("clipboard-list", clipboard._clip);
