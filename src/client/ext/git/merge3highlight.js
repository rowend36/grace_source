define(function(require,exports,module) {
    ...
    require("grace/core/config").ConfigEvents.on("git", update);
    ...
    Merge3Worker.prototype.annotate = require("grace/core/utils").Utils.debounce(function() {
    ...
    require("grace/core/utils").Utils.inherits(Merge3Worker, require("grace/core/events").EventsEmitter);
