    ...
    function doConfig(ev, prov, done) {
        var el = $(Notify.modal({
            ...
            form: [{
                    ...
                    type: 'password',
                    name: 'userPass',
                    caption: 'Password (Passwords are stored as plain text. It is advised you use a personal access token.)'
                },
        ...
        el.find("#showPassword").click(function() {
            ...
            $(this).hide().finish().delay(2000).queue().push(function() {
        ...
        forEach(Object.keys(config), function(i, index, next) {
        ...
        el.on('submit', function(e) {
            ...
            configure("gitUsername", el.find("#userName").val(), "git");
