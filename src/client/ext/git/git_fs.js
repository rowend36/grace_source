...
define(function(require,exports,module) {
    ...
    require("./git_commands").GitCommands.browseCommit = function(ev, prov) {
        require("./git_commands").GitCommands.promptCommit(prov, 'Enter commit id/message', function(ref) {
            var opts = {
                dir: prov.dir,
                gitdir: prov.gitdir,
                fs: prov.fs.id,
    ...
    function GitFileServer(opts) {
        BaseFs.call(this);
        var fs = require("grace/core/file_utils").FileUtils.getFileServer(opts.fs);
        this.opts = {
        ...
        this.stat = this.lstat = function(path, opts, cb) {
            ...
            this.resolveTree(segments.slice(0, -1), function(e, tree) {
                if (e) cb(e);
                    ...
                    return cb(null, require("grace/core/file_utils").FileUtils.createStats({
    ...
    require("grace/core/file_utils").FileUtils.registerFsExtension('!gitfs', null, function(opts) {
