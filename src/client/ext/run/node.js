define(function(require, exports, module) {
    ...
    var appConfig = require("grace/core/config").Config.allConfigs
        .execute;
            ...
            ajax(
                    ...
                    data: {
                        command: appConfig.buildCommand ?
                            appConfig.buildCommand.replace(
                                ...
                                doc && doc.getSavePath()) :
                            "npm build",
                        currentDir: currentDir == FileUtils
                            .NO_PROJECT ? "/" : currentDir,
                        password: appConfig
                ...
                function(req) {
                    ...
                    try {
                        ...
                        debug.log(e, res);
                        Notify.error(
                            'Invalid output received from server'
                        );
                    }
                }
            );
