define(function(require,exports,module) {
  ...
  var ChildStub = require("./file_browser").NestedBrowser;
  ...
  RecyclerStub.prototype.onBeforeRender = function() {
    ...
    this.scrollElement.css(
      ...
      this.paddingBottom + window.innerHeight/3 +
      "px"
...
*/
  ...
  Utils.inherits(RecyclerChildStub,RecyclerStub,ChildStub);
  ...
  Utils.inherits(RProjectView,RecyclerChildStub,ProjectView);
  RProjectView.prototype.superHierarchy = RecyclerChildStub.prototype;
  exports.RFileBrowser = RecyclerStub;
  exports.RProjectView = RProjectView;
  exports.RNestedBrowser = RecyclerChildStub;
}); /*_EndDefine*/