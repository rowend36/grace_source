define(function(require, exports, module) {
    ...
    function Sidenav(el, options) {
         ...
         */
        this.options = Object.assign({}, Sidenav.defaults, options);
        /**
        ...
        this._dragTarget = this.options.dragTarget;
        this._createOverlay();
    ...
    Sidenav.prototype = {
        ...
        "_onDragOpen": function _onDragOpen(e) {
            ...
            if (!this.isOverlay) {
                ...
                this.options.pushElements.css(this.options.edge == 'right' ? "margin-right" :
                    "margin-left", transformX + "px");
        ...
        "_onStartDragClose": function _onStartDragClose(e) {
            ...
            if (distanceFromEdge > -this.options.dragTargetWidth && distanceFromEdge < this.options
                .dragTargetWidth) {
                this._startDrag(e);
                this.$state = DRAGGING_OUT;
            }
        ...
        "_onDragClose": function _onDragClose(e) {
            ...
            if (!this.isOverlay) {
                ...
                this.options.pushElements.css(this.options.edge == 'right' ? "margin-right" :
                    "margin-left", this._width + transformX + "px");
        ...
        "close": function close(ev) {
            if (this.$state == PHASED_IN || this.$state === DRAGGING_IN) {} else if (this.$state ===
                PHASING_IN) {
                anim.remove(this.el);
                if (!this.isOverlay) {
                    anim.remove(this.options.pushElements.toArray());
        ...
        "_animateSidenavIn": function _animateSidenavIn(wasOpen) {
            ...
            slideOutPercent = this.options.edge === 'left' ? slideOutPercent + this.percentOpen :
        ...
        "_animateSidenavOut": function _animateSidenavOut(wasClosed) {
            ...
            var slideOutPercent = this.options.edge === 'left' ? endPercent + this.percentOpen :
