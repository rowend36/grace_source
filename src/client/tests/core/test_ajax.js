define(function(require, exports, module) {
    ...
    describe("ajax", function() {
        ...
        before(function() {
            ...
            var d = override(XMLHttpRequest
                .prototype, "send",
                function(a) {
                    this.body = a;
                    d.apply(this, arguments);
                });
            var e = override(XMLHttpRequest
                .prototype, "open",
                function(a, b, c) {
                    this.method = a;
                    this.url = b;
        ...
        after(function() {
            revert(XMLHttpRequest.prototype,
                "setRequestHeader");
            revert(XMLHttpRequest.prototype,
                "send");
            revert(XMLHttpRequest.prototype,
        ...
        it("should use encode post params as plaintext",
            function() {
                return ajax(
                        "../fixtures/8mb.html", {
                            data: {
        ...
        it("should use encode post params as formdata",
            function() {
                return ajax(
                        "../fixtures/8mb.html", {
                            data: {
            ...
            return ajax(
                ...
                .then(
                    function(req) {
                        expect(req.body).to.be
                            .undefined;
                        var d = new URL(window
                            .origin + '/' + req.url);
                        expect(d.search).to.equal(
                            "?a=hi&b%5Bc%5D=hello");
                    }
                );
        });
