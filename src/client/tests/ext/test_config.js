define(function (require, exports, module) {
    ...
    describe('EditConfig', function () {
        ...
        it('should parse rules', function () {
            ...
            expect(Config.allConfigs._triggers.rules.length).to.be.greaterThan(
                0
            );
        ...
        it('should handle boolean logic', function () {
            Configs.save({
                test: {
                    ...
                    '[ (!test.status && (test.name=Hi || !test.name) )].nums+': [
                        4,
                    ],
                    '[!(!!test.status && test.name)||test.status&&!test.name].nums+': [
                        5,
                    ],
                },
            });
