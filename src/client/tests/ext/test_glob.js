define(function(require,exports,module) {
    ...
    var quicks = {
        "main/main.js": [
            ...
            ["main/main.js",
                false
            ] //quickfilter does not match files
        ],
        "*/main.js": [
            ["main/", true],
            ["mon/", true],
    ...
    describe("Glob 2 Regex", function() {
        ...
        Object.keys(tests).forEach(function(e) {
            ...
            if (typeof cases[0] == "string") {
                cases.splice.apply(cases, [0, 1]
                    .concat(tests[cases[0]]));
            }
    ...
    describe("Directory filter", function() {
        var directoryFilter = require("grace/core/file_utils").FileUtils.genQuickFilter;
        var glob;
    ...
    describe("DDOS Filter", function() {
        it("should transform to safer forms", function() {
            ddos.forEach(function($case) {
                var basis = globToRegex($case[
                    0]);
                var control = globToRegex($case[
                    1]);
                expect(basis.source).to.equal(
                    control
                    .source);
            });
        });
