define(function (require, exports, module) {
  ...
  exports.createTests = function (provider) {
    var editor, plugin;
    function warn() {
      console.warn('Changing Session during test!!! ' + new Error().stack);
    }
    ...
    it('!setup', function (done) {
      ...
      //More time is needed for testLsp
      waterfall([
        function (n) {
          stage('document.^');
    ...
    it('should fulfil spec for normalizeName', function () {
      ...
      expect(plugin.normalizeName(plugin.normalizeName('current.js'))).to.equal(
        'current.js',
      );
    });
