define(function(require,exports,module) {
    ...
    var repeat = String.prototype.repeat ? function(amount, sep) {
    ...
    */
    ...
    exports.Utils = {
        ...
        guardEntry: function(func, _throw, errorText) {
            var guard = false;
            if (arguments.length < 3) errorText = 'Attempt to call' + func
                .name +
        ...
        inspect: function() {
            debug.debug(print.apply(null, arguments.length == 1 || typeof arguments[1] ==
                "number" ?
                arguments : [arguments]));
        },
        mergeList: mergeList,
