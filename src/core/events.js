_Define(function(global) {
    ...
    Object.assign(EventsEmitter.prototype, {
        ...
        on: function(event, func, capture) {
            ...
            if (this.checkEvents && !_eventRegistry.hasOwnProperty(event)) {
    ...
    global.AppEvents.checkEvents = true;
    global.AppEvents._eventRegistry = {
        ...
        'view-change': null,
        'fully-loaded': null,
        'filebrowsers-loaded': null,//unused, triggered when filebrowsers are first init
        'createDoc': null,
        'changeDoc': null,
        'deleteDoc': null,
        'renameDoc': null,
