...
Except when specified otherwise. All paths are resolved relative to the current project. Absolute paths are left as they are.\n Note: All configuration will be kept as long as the editor is running even if you close the active project. Modifications you make in this document will be saved in application memory and are loaded first before the application starts. Also see: autocompletion.preload,autocompletion.snippetsToLoad , application.theme etc.\n*/"
  );
