    ...
    */
    ...
    function ViewPager(editor) {
        ...
        this.enter = function(id, e) {
            var parent = currentView.parentNode;
            ...
            if (id && this.views[id]) {
                ...
                if (!hasParent) {
                    ...
                    if (newhost.onEnter) {
                        try {
                            ...
                            e.stopPropagation();
                            return forceClose(id, this.views[id]);
                        }
                    }
                ...
                if (newhost && newhost.onShow)
                    newhost.onShow(isIn, e);
                e.preventDefault();
            } else if (isIn) {
                if (host && host.onExit) {
                    try {
                        ...
                        console.error('Plugin: host.onExit threw exception ', e);
                    }
                }
                /*start switch*/
                currentView.remove();
    ...
    ViewPager.prototype.exit = function() {
        this.enter(null);
    };
