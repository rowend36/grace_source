(function(global) {
    ...
    function RecyclerRenderer() {
        ...
        this.start = -1;
        this.changes = 0;
        this.viewport = Object.assign({}, this.DEFAULT_VIEWPORT);
        this.paddingTop;
        this.lastIndex = 0;
    }
    /*Overrides*/
    ...
    RecyclerRenderer.prototype.INFINITE_VIEWPORT = { y: -Infinity, height: Infinity };
    ...
    RecyclerRenderer.prototype.getViewport = function(viewport) {
        if (viewport) { throw 'Error: use scrollTo to change viewport' }
