_Define(function(global) {
    ...
    function RecyclerStub(id, rootDir, fileServer, noReload, renderer) {
        ...
        this.cache = new FastCache(
            new RecyclerViewCache(function() {
                ...
                view.innerHTML = "<li class=\"file-item\" style='position:absolute;top:0px;'><span><i class = 'type-icon material-icons'>folder</i></span><span class='filename'>" +
    ...
    RecyclerStub.prototype.pageSize = 5000;
    ...
    RecyclerStub.prototype.onBeforeRender = function() {
        ...
        this.root.css("height", this.paddingTop + this.renderer.height + this.paddingBottom + "px");
        this.scrollElement.css("height", this.paddingTop + this.renderer.height + this.paddingBottom + window.innerHeight / 2 + "px");
        this.bottomElement && this.bottomElement.css("top", this.renderer.height + "px");
    ...
    RecyclerStub.prototype.showInlineDialog = function(el, m, status, p) {
        ...
        this.superClass.showInlineDialog.apply(this, [el, m, status || "Enter name", p]);
    ...
    FileItemHolder.prototype.render = function(viewport, index, insertBefore, restack) {
        if (this.widget) {
            ...
            if (!this.visible || restack) {
                ...
                else if (next && !insertBefore && (i != this.renderer.renderlist.length - 1)) {
    ...
    FileItemHolder.prototype.attr = function(text, value = FileItemHolder.prototype.null) {
        if (value == this.null) {
    ...
    FileItemHolder.prototype.hasClass = function(text) {
        return this.view ? this.view.hasClass(text) : this.classes.indexOf(text) > -1
    }
...
*/
    ...
    RecyclerChildStub.prototype.expandFolder = function(name, callback) {
        ...
        var callback2 = (function() {
            this.extraSpace[this.hier.indexOf(name)] = this.childStubs[name].renderer.height;
            if (callback)
                callback(this.childStubs[name]);
        }).bind(this)
    ...
    RecyclerChildStub.prototype.getScreenTop = function() {
        var top = 0;
        var parent = this;
    ...
    RecyclerChildStub.prototype.foldFolder = function(name) {
        ...
        this.childStubs[name].renderer.hide();
        this.handleScroll();
    }
